...
class Validators {
  ...
  static String? _lengthCheck(String? text, int length) {
    final String lengthError =
        'Precisa ser igual ou maior a $length caracteres';
  ...
  static String? _upperCaseCheck(String text) {
    ...
    if (!containsUpperCase) return 'Precisa ter letras maiusculas.';
    return null;
  }
  ...
  static String? _lowerCaseCheck(String text) {
    final bool containsLowerCase =
        RegExp(r'^(?=.*?[a-z]).{1,}$').hasMatch(text);
    if (!containsLowerCase) return 'Precisa ter letras minusculas.';
    return null;
  }
  ...
  static String? _numberCheck(String text) {
    ...
    if (!containsNumber) return 'Precisa conter ao menos um numero.';
    return null;
  }
  ...
  static String? _spaceCheck(String text) {
    ...
    if (containsSpace) return 'Não pode conter espaços em branco.';
    return null;
  }
}
